...
?>
	...
	<form method="post" action="purchase.php" class="form-horizontal">
		...
		<div class="form-group">
			<label for="pin_code" class="control-label col-md-4">PIN Code</label>
			<div class="col-md-4">
				<input type="text" name="pin_code" class="col-md-4" class="form-control" pattern="[0-9]{6}" title="Six digit PIN Code" maxlength="6" required>
			</div>
		</div>
		<div class="form-group">
	...
	<p class="lead">Please press Confirm to confirm your Shipping Details.</p>
<?php
	} else {
