...
?>
	...
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
				<input type="text" class="form-control" name="card_number" pattern="[0-9]{16}" title="16 digit Card no." maxlength="16" required>
            </div>
        </div>
        <div class="form-group">
	...
	<p class="lead">Please press Purchase to confirm your Order.</p>
	<p class="lead">Please press Cancel to clear all Details.</p>
<?php
	} else {
